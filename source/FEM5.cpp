...
void assembleGlobal(double K[15][15], double kg[6][6], int n1, int n2) {
...
void assembleLoad(double F[15], double fe[6], int n1, int n2) {
...
void applyBC(double K[15][15], double F[15], vector<int> bc) {
...
void solveSystem(double K[15][15], double F[15], double U[15]) {
...
void elementForces(const Element &e, double U[15], ofstream &out) {
...
elements.push_back({2,2,3,E,A2,I2,q,"local"});
elements.push_back({3,3,4,E,A2,I2,q,"local"});
...
double K_original[15][15];
double F_original[15];
